...
CREATE OR REPLACE FUNCTION public.get_property_comparables_public(limit_rows integer DEFAULT 50, offset_rows integer DEFAULT 0)
RETURNS TABLE(id uuid, general_location text, price_range text, total_area numeric, approximate_latitude numeric, approximate_longitude numeric, property_type text, estrato_social estrato_social)
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = 'public'
AS $$
