-- Create an advanced function to find the best comparables for appraisal
...
BEGIN
  ...
  with_scores AS (
    SELECT 
      dc.*,
      -- Area similarity score (higher is better, max 1.0)
      CASE 
  ...
  SELECT 
    ...
    -- Overall similarity score (combination of area and distance)
    ROUND(
      CAST(
