-- CORRECCIÓN CRÍTICA DE SEGURIDAD: Proteger datos de propiedades (FIJO)

-- 1) Eliminar política pública existente
...
-- 2) Crear política restrictiva para usuarios autenticados únicamente
...
-- 3) Crear vista pública con datos sanitizados
...
-- 4) Función pública que retorna datos sanitizados
