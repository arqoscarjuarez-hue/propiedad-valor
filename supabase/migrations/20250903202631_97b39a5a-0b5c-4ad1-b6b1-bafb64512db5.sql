-- Security Fix: Step-by-step approach to handle existing data

-- First, let's update the existing "visitante" entries to use a proper UUID
-- We'll use a special UUID for anonymous/guest users
UPDATE public.comments 
SET user_id = '00000000-0000-0000-0000-000000000000'
WHERE user_id = 'visitante';
...
-- Create proper policies for comments (now with UUID user_id)
