          ...
          <div className="lg:col-span-1">
            <Card className="shadow-lg">
              ...
              <CardContent className="p-3 sm:p-6">
                ...
                <div className="mb-6">
                  <Label htmlFor="estratoSocial" className="text-base font-semibold">Estrato Social</Label>
                             ...
                             <TableHeader>
                               <TableRow>
                                 <TableHead>Dirección</TableHead>
                                  <TableHead className="text-right">Precio ajustado (-20%)</TableHead>
                                  <TableHead className="text-right">Precio/m² ajustado (-20%)</TableHead>
                               ...
                               {comparables.map((c) => (
                                 <TableRow key={c.id}>
                                   <TableCell className="max-w-[220px] truncate">{c.address}</TableCell>
                                    <TableCell className="text-right">${Math.round((c.price_usd || 0) * 0.80).toLocaleString("en-US")}</TableCell>
                                    <TableCell className="text-right">${Math.round((c.price_per_sqm_usd || 0) * 0.80).toLocaleString("en-US")}</TableCell>
