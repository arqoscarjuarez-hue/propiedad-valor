...
const translations = {
  es: {
    ...
    mediumCondition: 'MEDIO - Conservación promedio, uso normal visible (Ross-Heindecke: Factor 0.85)',
  ...
  en: {
    ...
    mediumCondition: 'MEDIUM - Average conservation, normal visible use (Ross-Heindecke: Factor 0.85)',
  ...
  fr: {
    ...
    mediumCondition: 'MOYEN - Conservation moyenne, usage normal visible (Ross-Heindecke: Facteur 0.85)',
  ...
  de: {
    ...
    mediumCondition: 'MITTEL - Durchschnittliche Erhaltung, normale sichtbare Nutzung (Ross-Heindecke: Faktor 0.85)',
  ...
  it: {
    ...
    mediumCondition: 'MEDIO - Conservazione media, uso normale visibile (Ross-Heindecke: Fattore 0.85)',
  ...
  pt: {
    ...
    mediumCondition: 'MÉDIO - Conservação média, uso normal visível (Ross-Heindecke: Fator 0.85)',
