  ...
  const calculateValuation = async () => {
    ...
    try {
      ...
      const locationFactors = {
        ...
        'estrato-7-social': 0.30,        // Zona de interés social
        'estrato-6-bajo': 0.50,          // Zona popular
        'estrato-5-medio-bajo': 0.70,    // Zona media-baja
