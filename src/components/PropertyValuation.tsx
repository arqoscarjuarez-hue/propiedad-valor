          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-3 sm:p-6">
              ...
              <div className="space-y-2 text-sm mb-4 border-b pb-4">
                <h4 className="text-sm font-medium mb-3 text-primary">📏 Áreas de la Propiedad</h4>
                
                {/* Área de Construcción - Siempre mostrar para propiedades construidas */}
                {propertyData.tipoPropiedad !== 'terreno' && (
                  <div className="flex justify-between p-2 bg-muted/30 rounded">
                    <span className="font-medium">Área de Construcción:</span>
                ...
                {/* Área de Terreno - Siempre mostrar */}
                <div className="flex justify-between p-2 bg-muted/30 rounded">
                  <span className="font-medium">Área de Terreno:</span>
                  <span className="font-bold text-primary">{propertyData.areaTerreno || 0} m²</span>
                </div>
                
                {/* Información adicional de espacios */}
                {(propertyData.recamaras > 0 || propertyData.banos > 0 || propertyData.antiguedad > 0) && (
                  <div className="mt-3 pt-2 border-t">
                    <h5 className="text-xs font-medium mb-2 text-muted-foreground">Detalles adicionales:</h5>
                ...
                {/* Mensaje cuando no hay áreas configuradas */}
                {(propertyData.areaTerreno || 0) === 0 && 
                 (propertyData.tipoPropiedad === 'terreno' || 
                  (propertyData.tipoPropiedad === 'apartamento' && (propertyData.areaApartamento || 0) === 0) ||
                  (propertyData.tipoPropiedad !== 'apartamento' && propertyData.tipoPropiedad !== 'terreno' && 
                   ((propertyData.areaSotano || 0) + (propertyData.areaPrimerNivel || 0) + (propertyData.areaSegundoNivel || 0) + 
                    (propertyData.areaTercerNivel || 0) + (propertyData.areaCuartoNivel || 0)) === 0)) && (
                  <div className="mt-2 p-2 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded text-xs text-yellow-800 dark:text-yellow-200">
                    ⚠️ Configure las áreas en la pestaña "Áreas" para obtener una valuación precisa
                  </div>
                )}
              </div>
